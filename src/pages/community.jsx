            ...
            <Container>
                <div className="w-full max-w-[1188px] mx-auto grid place-items-center">
                    ...
                    <h5 className='text-[#B0BDB9] text-center text-[20px] leading-[36px] lg:leading-[57.6px] lg:text-[32px] my-5'>
                        At Creos, we&rsquo;re on the lookout for revolutionary creators, visionaries who are reshaping the world as we know it. If you&rsquo;ve got what it takes to be part of our vibrant community, there are three pathways to join us:
                    </h5>
                </div>
            </Container>
        </header>
            ...
            <Container>
                <div className="flex flex-col gap-[95px]">
                    <section className="grid lg:grid-cols-2 gap-[74px]">
                        <div className="flex">
                            <div className="my-auto">
                                <h1 className="text-[#222222] text-[32px] lg:text-[48px] font-extrabold">We&rsquo;re Watching</h1>
                                <p className="lg:text-[24px] py-[29px] leading-[43px] text-black">
                                    Creos scouts the globe for groundbreaking innovators challenging the status quo. When we discover your exceptional work, we extend a personal invitation to join our community—all at our expense. <br /><br />

                                    Want to increase your chances? Share your LinkedIn profile with us, and let your achievements speak for themselves.
                                </p>
                                <div className="mb-5">
                                    <Input
                                        className="border-[1px] border-[#012B1D] placeholder-primary outline-primary"
                    ...
                    <section className="grid lg:grid-cols-2 gap-[134px]">
                        ...
                        <div className="flex">
                            <div className="my-auto">
                                <h1 className="text-[#222222] text-[32px] lg:text-[48px] font-extrabold">Pay for Membership</h1>
                                <p className="lg:text-[24px] py-[29px] leading-[43px] text-black">
                                    Already confident you&rsquo;re a perfect fit for Creos? You can expedite your entry by opting for our paid membership. For a fee of $2,000, here&rsquo;s what you get:
                                </p>
                                <ul className="lg:text-[24px] py-[32px] leading-[43px] text-black flex flex-col gap-2">
                                    <li className="pl-6 relative before:absolute before:left-0 before:top-[10px] before:h-2 before:w-2 before:rounded-[100%] before:bg-black before:top-[18px]">
                                        Instant Global Recognition: Your unique story will be featured in press releases across 12+ international platforms, amplifying your reach and influence.
                                    </li>
                                    <li className="pl-6 relative before:absolute before:left-0 before:top-[10px] before:h-2 before:w-2 before:rounded-[100%] before:bg-black before:top-[18px]">
                                        Personalized Spotlight: Creos Press will conduct a live one-on-one interview, delving into the fascinating tale of how it all began for you.
                                    </li>
                                    <li className="pl-6 relative before:absolute before:left-0 before:top-[10px] before:h-2 before:w-2 before:rounded-[100%] before:bg-black before:top-[18px]">
                                        Exclusive Membership Kit: Welcome to Creos with an official Non-Fungible Token (NFT) identity card, a symbol of your unique presence within our community. Plus, receive a physical membership card for blockchain verification and networking opportunities.
                                    </li>
                                </ul>
            ...
            <Container>
                <div className="w-full max-w-[1030px] mx-auto grid place-items-center relative">
                    ...
                    <h5 className='text-[#E6EAE8] text-center text-[20px] leading-[36px] lg:leading-[43px] lg:text-[24px] my-5'>
                        At Creos, we&rsquo;re more than a community; we&rsquo;re a movement driving change. Here, innovation meets recognition, and creativity finds its stage. When you join Creos, you&rsquo;re not just joining a network; you&rsquo;re becoming part of a family of disruptors, inventors, and pioneers shaping the future. <br /> <br />
