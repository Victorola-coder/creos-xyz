            ...
            <div className="flex flex-wrap gap-[20px] pt-[90px] lg:gap-[100px] justify-around">
                {
                    teamMembersData.map(team => (
                        <div key={team.id}>
                            <img src={team.img} alt={team.name} className="w-[300px] h-[300px] mix-blend-luminosity" />
                            <div className="grid place-items-center gap-[11px] py-[30px]">
                                <h1 className="text-[28px] lg:text-[32px] font-extrabold text-[#E6EAE8]">{team.name}</h1>
