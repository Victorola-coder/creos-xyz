  ...
  switch (index) {
      ...
      return (
        ...
        >
          <div className='flex flex-col gap-[24px]'>
            <header>
              <h2 className='font-sat text-[#564737] lg:text-[24px] mb-[20px] '>
                Creos Edu and Mentors Platform
              </h2>
              <h1 className='text-[28px] lg:text-[48px] leading-[42px] lg:leading-[72px] font-extrabold text-[#222222]'>
                Empowering the Next Generation of Innovators
              </h1>
            </header>
            <p className='text-[#000000] leading-[28px] lg:leading-[43px] lg:text-[24px]'>
              Creos Edu is where knowledge meets creativity. Our platform is
              dedicated to providing top-notch educational resources, workshops,
              and courses, curated by experts from various fields.{' '}
            </p>
            <div>
              <Link to='/waitlist'>
    ...
    case 1: {
      return (
        ...
        >
          ...
          <figure className='hidden lg:flex flex-col gap-[20px]'>
            <img
              src='/images/product-card-img-2.svg'
              alt='Product Card'
              draggable={false}
              className='w-full'
            />
    ...
    case 2: {
      return (
        <div
          ref={ref}
          className={`select-none grid lg:grid-cols-2 gap-[30px] lg:gap-[63px] bg-[#564737] px-[20px] py-[30px] lg:px-[100px] lg:py-[101px] rounded-[20px] lg:rounded-[100px] ${
            className ?? ''
          }`}
        >
          <div className='flex flex-col gap-[24px]'>
          ...
          <figure className='hidden lg:flex flex-col gap-[20px]'>
            <img
              src='/images/product-card-img-3.svg'
              alt='Product Card'
              draggable={false}
              className='w-full'
            />
