...
export default function Navbar() {
  ...
  return (
    <header>
      <nav className='fixe flex flex-row rounded-[100px] border-[#E6EAE8] border-solid border-[5px] items-center justify-between gap-[200px] lg:mx-[100px] my-[20px] px-[20px] py-[18px] md:py-[10px] lg:my-[60px] lg:px-[60px] lg:py-[34px]'>
        <Link to='/'>
