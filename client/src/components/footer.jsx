    ...
    <footer className='lg:mt-[100px] font-sat bg-[#E6EAE8]'>
      ...
      >
        <div className='flex flex-col justify-center lg:gap-[350px] lg:flex lg:flex-row lg:items-center'>
          <H3
            className={`text-bas text-[#000F0A] text-2xl max-w-[353px] md:text-[30px] md:leading-[40px] lg:text-[32px] md:max-w-[784px] lg:tracking-[-0.2px] lg:leading-[48px]`}
          >
        ...
        {/* line */}
        <div className='bg-primary w-full h-[1px] my-[20px] md:my-[30px] lg:my-[50px]'></div>
