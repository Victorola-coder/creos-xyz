    ...
    <>
      ...
      <div className='flex flex-col gap-[64px]'>
        ...
        <div className='flex justify-between'>
          <h4 className='font-sat text-2xl leading-[36px] font-medium text-primary'>
            {eventCount} <span>Events</span>
          </h4>
          <div className='flex !transition-none !duration-0 flex-row items-center justify-center gap-3'>
            <button
              onClick={handleListView}
              className='flex gap-5 items-center text-primary text-xl font-bold'
            >
              <div
...
const ListView = () => {
  return (
    <div className='border-[1px] border-black'>
      <header className='px-[20px] grid grid-cols-[94px_1.5fr_1fr_1fr_1fr_1fr] gap-[40px] text-2xl font-bold text-primary py-[25px]'>
        <div></div>
        <h1>Event Name</h1>
        <h1>Event Date</h1>
        <h1>Event Time</h1>
      ...
      {[...Array(3)].map((_, i) => (
        <div
          key={i}
          className='border-t-[1px] border-black px-[20px] grid grid-cols-[94px_1.5fr_1fr_1fr_1fr_1fr] gap-[40px] items-center text-2xl text-primary py-[25px]'
        >
